...
app.post('/articles', (request, response) => {
  // COMMENTed: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // These lines of code are interacting with the (2)request, query(3), result(4), and response(5), portion of the full-stack-diagram.png. This interacts with the insertRecord record method of article.js, This is enacting the create portion of CRUD.
  client.query(
    `INSERT INTO
...
app.put('/articles/:id', (request, response) => {
  // COMMENTed: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // These lines of code are interacting with the (2)request, query(3), result(4), and response(5), portion of the full-stack-diagram.png. This interacts with the updateRecord method of article.js, This is enacting the Update portion of CRUD.
  client.query(
    `UPDATE articles
    SET
      title=$1,
...
app.delete('/articles/:id', (request, response) => {
  // COMMENTed: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // These lines of code are interacting with the (2)request, query(3), result(4), and response(5), portion of the full-stack-diagram.png. This interacts with the deleteRecord method of article.js, This is enacting the Delete portion of CRUD.
  client.query(
...
function loadArticles() {
  ...
  // COMMENTed: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // // These lines of code are interacting with the  query(3), and result(4) portion of the full-stack-diagram.png. This does not interact with any methods of article.js as it is invoked directly out of loadDB. This is enacting the create portion of CRUD.
